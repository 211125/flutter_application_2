...
import 'package:flutter_application_1/publication/domain/usecases/getMap_usecase.dart';
...
import 'package:flutter_application_1/publication/domain/usecases/poshMap_usecase.dart';
...
class PostcaseConfig {
  ...
  CreatemapUseCase? createmapUseCase;
  ...
  PostcaseConfig() {
    ...
    getmapUseCase = GetmapUseCase(poshRepositoryImpl!);
    createmapUseCase = CreatemapUseCase(poshRepositoryImpl!);
