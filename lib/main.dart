...
import 'package:flutter_application_1/publication/presentations/bloc/getmap/getmap_bloc.dart';
...
import 'package:flutter_application_1/publication/presentations/bloc/poshMapa/postUser_bloc.dart';
...
import 'package:flutter_application_1/publication/presentations/pages/mapa/getmap_page.dart';
    ...
    MultiProvider(
      providers: [
       ...
       // Provider<poshLocalDataSourceImp>( 
        ...
        BlocProvider<GetmapBloc>(
          create: (context) => GetmapBloc(
              getmapUseCase: postcaseConfig.getmapUseCase
          ),
        ),

        BlocProvider<CreatemapBloc>(
          create: (context) => CreatemapBloc(
              createmapUseCase: postcaseConfig.createmapUseCase
          ),
        ),
//User
